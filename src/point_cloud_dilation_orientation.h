...
struct OrientationDilationConfig {
    float    cell_size;
    float    min_dist;
...
class PointCloudOrientationDilator {
public:
    explicit PointCloudOrientationDilator(const OrientationDilationConfig& cfg);
...
private:
    ...
    OrientationDilationConfig  m_cfg;
